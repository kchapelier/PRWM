...
var argv = yargs.usage('Usage: obj2prwm -i inputFile -o outputFile [options]')
    ...
    .alias('o', 'out')
    .describe('simplify', 'Simplification amount, a higher value means a more simplified mesh')
    .describe('scale', 'Scale used for the bezier curves, a higher value means a better resolution')
